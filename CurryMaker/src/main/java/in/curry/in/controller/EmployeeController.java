...
public class EmployeeController {
			...
			) 
	{
		...
		try {
			...
			String msg = "New curry details with id  '"+id+"' saved";
			log.debug("Curry details saved with {}",id);
			...
			) 
	{
		...
		try {
			...
			model.addAttribute("msg", "Curry details with id '"+empId+"' Deleted");
			...
			) 
	{
		...
		model.addAttribute("msg", "Curry with id '"+employee.getEmpId()+"' Updated!!");
		return "EmployeeData";
		//return "redirect:all";
	}
